  ...
  function receiveOperation(operationJSON) {
    if(operationJSON) {
      ...
      if(operationJSON.root) {
        ...
        if(operationJSON.root.values.type === "commitTransactionCompletedOperation" && (createdAppClients = operationJSON.root.values.data?.createdDataObjects["data/main.datareel/model/app/app-client"]?.rawData)) {
          ...
          console.log("received commitTransactionCompletedOperation for provisioning Practice:",operationJSON);
        }
      }
