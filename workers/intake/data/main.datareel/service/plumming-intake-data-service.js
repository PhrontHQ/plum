// const { map } = require("montage/core/collections/shim-object");
// const { resetUnhandledRejections } = require("montage/core/q");
...
var DataService = require("montage/data/service/data-service").DataService,
    ...
    DataTrigger = require("phront/data/main.datareel/service/data-trigger").DataTrigger,
    ...
    Country = require("phront/data/main.datareel/model/country").Country,
    ...
    CognitoUserPoolClient = require("phront/data/main.datareel/model/aws/cognito/user-pool-client").UserPoolClient,

    UserPool = require("phront/data/main.datareel/model/app/user-pool").UserPool,
    //UserPoolClient = require("phront/data/main.datareel/model/app/user-pool-client").UserPoolClient,
    ...
    PartyPostalAddress = require("phront/data/main.datareel/model/messaging-channel/party-postal-address").PartyPostalAddress,
    EmailAddress = require("phront/data/main.datareel/model/messaging-channel/email-address").EmailAddress,
    PartyEmailAddress = require("phront/data/main.datareel/model/messaging-channel/party-email-address").PartyEmailAddress,
    PhoneNumber = require("phront/data/main.datareel/model/messaging-channel/phone-number").PhoneNumber,
    PartyPhoneNumber = require("phront/data/main.datareel/model/messaging-channel/party-phone-number").PartyPhoneNumber,
    PartySMSNumber = require("phront/data/main.datareel/model/messaging-channel/party-s-m-s-number").PartySMSNumber,
    ContactForm = require("phront/data/main.datareel/model/messaging-channel/contact-form").ContactForm,
    PartyContactForm = require("phront/data/main.datareel/model/messaging-channel/party-contact-form").PartyContactForm,
    InstantMessageAddress = require("phront/data/main.datareel/model/messaging-channel/instant-message-address").InstantMessageAddress,
    PartyInstantMessageAddress = require("phront/data/main.datareel/model/messaging-channel/party-instant-message-address").PartyInstantMessageAddress,
    ...
    CustomerEngagementQuestionnaire = require("phront/data/main.datareel/model/customer-engagement-questionnaire").CustomerEngagementQuestionnaire,
    ...
    PersonalRelationship = require("phront/data/main.datareel/model/personal-relationship").PersonalRelationship,
    ...
    B2CCustomerSupplierResponsibleParty = require("phront/data/main.datareel/model/b-2-c-customer-supplier-responsible-party").B2CCustomerSupplierResponsibleParty,
    RoleRanking = require("phront/data/main.datareel/model/role-ranking").RoleRanking,
    Asset = require("phront/data/main.datareel/model/asset").Asset,
    Gender = require("phront/data/main.datareel/model/gender").Gender,
    PersonName = require("phront/data/main.datareel/model/person-name").PersonName,
    ServiceProductVariant = require("phront/data/main.datareel/model/service-product-variant").ServiceProductVariant,
    ...
    Variable = require("phront/data/main.datareel/model/questionnaire/variable").Variable,
    ...
    Question = require("phront/data/main.datareel/model/questionnaire/question").Question,
    QuestionnaireQuestion = require("phront/data/main.datareel/model/questionnaire/questionnaire-question").QuestionnaireQuestion,
        ...
        value: function(mergeOperation) {
            ...
            .then(() => {
                ...
                */
                    ...
                    rawCountryDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/country_types"),
                    rawPracticeDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/practice"),
    ...
    createPerson: {
        value: function(rawData, originIdValue, createTransactionOperation) {
            ...
            var mainService = this.rootService,
                self = this,
                rawCountryDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/country_types"),
                rawPhoneLabelObjectDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/phone_label_types"),
                ...
                rawGenderDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/gender_types"),
                countryId = rawData.country_id === 0 ? 26 : rawData.country_id,
                genderPromise;
    ...
    performStaffMembersMergeOperation: {
        value: function(mergeOperation) {
            ...
            var self = this,
                ...
                roleObjectDescriptor = mainService.objectDescriptorForType(Role),
                role,
                rawStaffTypeDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/staff_types"),
    ...
    performPatientsMergeOperation: {
        value: function(mergeOperation) {
            ...
            var self = this,
                ...
                phrontPersonObjectDescriptor = mainService.objectDescriptorForType(Person),
                rawLanguageTypesDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/language_types"),
                rawAccountRelationshipTypesDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/account_relationship_types"),
    ...
    performAppointmentsMergeOperation: {
        value: function(mergeOperation) {
            ...
            var self = this,
                ...
                rawAppointmentStatusDescriptor = mainService.objectDescriptorWithModuleId("data/main.datareel/model/appointment_status_types");
