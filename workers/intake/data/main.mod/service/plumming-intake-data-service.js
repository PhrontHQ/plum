...
var DataService = require("montage/data/service/data-service").DataService,
    ...
    DataTrigger = require("phront/data/main.mod/service/data-trigger").DataTrigger,
    ...
    Country = require("phront/data/main.mod/model/country").Country,
    ...
    CognitoUserPoolClient = require("phront/data/main.mod/model/aws/cognito/user-pool-client").UserPoolClient,

    UserPool = require("phront/data/main.mod/model/app/user-pool").UserPool,
    //UserPoolClient = require("phront/data/main.mod/model/app/user-pool-client").UserPoolClient,
    ...
    PartyPostalAddress = require("phront/data/main.mod/model/messaging-channel/party-postal-address").PartyPostalAddress,
    EmailAddress = require("phront/data/main.mod/model/messaging-channel/email-address").EmailAddress,
    PartyEmailAddress = require("phront/data/main.mod/model/messaging-channel/party-email-address").PartyEmailAddress,
    PhoneNumber = require("phront/data/main.mod/model/messaging-channel/phone-number").PhoneNumber,
    PartyPhoneNumber = require("phront/data/main.mod/model/messaging-channel/party-phone-number").PartyPhoneNumber,
    PartySMSNumber = require("phront/data/main.mod/model/messaging-channel/party-s-m-s-number").PartySMSNumber,
    ContactForm = require("phront/data/main.mod/model/messaging-channel/contact-form").ContactForm,
    PartyContactForm = require("phront/data/main.mod/model/messaging-channel/party-contact-form").PartyContactForm,
    InstantMessageAddress = require("phront/data/main.mod/model/messaging-channel/instant-message-address").InstantMessageAddress,
    PartyInstantMessageAddress = require("phront/data/main.mod/model/messaging-channel/party-instant-message-address").PartyInstantMessageAddress,
    ...
    CustomerEngagementQuestionnaire = require("phront/data/main.mod/model/customer-engagement-questionnaire").CustomerEngagementQuestionnaire,
    ...
    PersonalRelationship = require("phront/data/main.mod/model/personal-relationship").PersonalRelationship,
    ...
    B2CCustomerSupplierResponsibleParty = require("phront/data/main.mod/model/b-2-c-customer-supplier-responsible-party").B2CCustomerSupplierResponsibleParty,
    RoleRanking = require("phront/data/main.mod/model/role-ranking").RoleRanking,
    Asset = require("phront/data/main.mod/model/asset").Asset,
    Gender = require("phront/data/main.mod/model/gender").Gender,
    PersonName = require("phront/data/main.mod/model/person-name").PersonName,
    ServiceProductVariant = require("phront/data/main.mod/model/service-product-variant").ServiceProductVariant,
    ...
    Variable = require("phront/data/main.mod/model/questionnaire/variable").Variable,
    ...
    Question = require("phront/data/main.mod/model/questionnaire/question").Question,
    QuestionnaireQuestion = require("phront/data/main.mod/model/questionnaire/questionnaire-question").QuestionnaireQuestion,
