var DataEditor = require("montage/ui/data-editor").DataEditor,
    ...
    ExpiringAssetDownload = require("phront/data/main.datareel/model/expiring-asset-download").ExpiringAssetDownload,
    ExpiringObjectDownload = require("phront/data/main.datareel/model/aws/s3/expiring-object-download").ExpiringObjectDownload,

    KeyComposer = require("montage/composer/key-composer").KeyComposer;

exports.Main = DataEditor.specialize({
